...
class FlaschenpostPut extends $pb.GeneratedMessage {
  factory FlaschenpostPut({
    ...
    if (returnPath != null) result.returnPath = returnPath;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.List<$core.int>>(
        6, _omitFieldNames ? '' : 'returnPath', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  /// MS06: serialized return-path block ([20 ack_oh_id][16 ack_session_tag][1 hop_count]
  /// [hop_count x (20 kad_id + 32 enc_pub)]), preserved when a CMD_DELIVER_ACKED deliver falls
  /// back to this MS02b forwarding — the node that makes the final deposit decision builds and
  /// sends the R-ACK (see ReturnPath / RoutingAckSender). Empty (unset) = no R-ACK requested.
  @$pb.TagNumber(6)
  $core.List<$core.int> get returnPath => $_getN(5);
  @$pb.TagNumber(6)
  set returnPath($core.List<$core.int> value) => $_setBytes(5, value);
  @$pb.TagNumber(6)
  $core.bool hasReturnPath() => $_has(5);
  @$pb.TagNumber(6)
  void clearReturnPath() => $_clearField(6);
}
